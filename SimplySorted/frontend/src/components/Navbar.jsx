...
const navigation = [
  ...
  { name: 'Memos', href: '/memo', current: false },
  { name: 'Priority', href: '/Priority', current: false },
];
...
export default function Navbar() {
  useEffect(() => {
    ...
    } else if (location.pathname == '/Priority') {
                ...
                <Menu as="div" className="relative ml-3">
                  <div>
                    <Menu.Button className="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                      ...
                      <Bars3Icon
                        className="block h-6 w-6 text-gray-400 hover:text-white "
                        aria-hidden="true"
                      />
                    </Menu.Button>
                  </div>
